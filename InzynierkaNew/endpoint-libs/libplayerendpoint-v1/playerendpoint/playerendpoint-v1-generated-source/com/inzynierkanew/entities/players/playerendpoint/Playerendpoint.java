...
public class Playerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "findPlayerByName".
   *
   * This request holds the parameters needed by the playerendpoint server.  After setting any
   * optional parameters, call the {@link FindPlayerByName#execute()} method to invoke the remote
   * operation.
   *
   * @param name
   * @return the request
   */
  public FindPlayerByName findPlayerByName(java.lang.String name) throws java.io.IOException {
    FindPlayerByName result = new FindPlayerByName(name);
    initialize(result);
    return result;
  }

  public class FindPlayerByName extends PlayerendpointRequest<com.inzynierkanew.entities.players.playerendpoint.model.Player> {

    private static final String REST_PATH = "findPlayerByName/{name}";
     ...
     * This request holds the parameters needed by the the playerendpoint server.  After setting any
     * optional parameters, call the {@link FindPlayerByName#execute()} method to invoke the remote
     * operation. <p> {@link FindPlayerByName#initialize(com.google.api.client.googleapis.services.Abs
     ...
     * @since 1.13
     */
    protected FindPlayerByName(java.lang.String name) {
      super(Playerendpoint.this, "POST", REST_PATH, null, com.inzynierkanew.entities.players.playerendpoint.model.Player.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public FindPlayerByName setAlt(java.lang.String alt) {
      return (FindPlayerByName) super.setAlt(alt);
    }

    @Override
    public FindPlayerByName setFields(java.lang.String fields) {
      return (FindPlayerByName) super.setFields(fields);
    }

    @Override
    public FindPlayerByName setKey(java.lang.String key) {
      return (FindPlayerByName) super.setKey(key);
    }

    @Override
    public FindPlayerByName setOauthToken(java.lang.String oauthToken) {
      return (FindPlayerByName) super.setOauthToken(oauthToken);
    }

    @Override
    public FindPlayerByName setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindPlayerByName) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindPlayerByName setQuotaUser(java.lang.String quotaUser) {
      return (FindPlayerByName) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindPlayerByName setUserIp(java.lang.String userIp) {
      return (FindPlayerByName) super.setUserIp(userIp);
    }
    ...
    public FindPlayerByName setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public FindPlayerByName set(String parameterName, Object value) {
      return (FindPlayerByName) super.set(parameterName, value);
    }
  }
