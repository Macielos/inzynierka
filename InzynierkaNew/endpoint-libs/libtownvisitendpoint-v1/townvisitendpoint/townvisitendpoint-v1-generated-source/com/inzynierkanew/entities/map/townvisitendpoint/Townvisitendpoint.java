...
public class Townvisitendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "insertTownVisit".
   *
   * This request holds the parameters needed by the townvisitendpoint server.  After setting any
   * optional parameters, call the {@link InsertTownVisit#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit}
   * @return the request
   */
  public InsertTownVisit insertTownVisit(com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit content) throws java.io.IOException {
    InsertTownVisit result = new InsertTownVisit(content);
    initialize(result);
    return result;
  }

  public class InsertTownVisit extends TownvisitendpointRequest<com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit> {
     ...
     *
     * This request holds the parameters needed by the the townvisitendpoint server.  After setting
     * any optional parameters, call the {@link InsertTownVisit#execute()} method to invoke the remote
     * operation. <p> {@link InsertTownVisit#initialize(com.google.api.client.googleapis.services.Abst
     ...
     * @since 1.13
     */
    protected InsertTownVisit(com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit content) {
    ...
    @Override
    public InsertTownVisit setAlt(java.lang.String alt) {
      return (InsertTownVisit) super.setAlt(alt);
    }

    @Override
    public InsertTownVisit setFields(java.lang.String fields) {
      return (InsertTownVisit) super.setFields(fields);
    }

    @Override
    public InsertTownVisit setKey(java.lang.String key) {
      return (InsertTownVisit) super.setKey(key);
    }

    @Override
    public InsertTownVisit setOauthToken(java.lang.String oauthToken) {
      return (InsertTownVisit) super.setOauthToken(oauthToken);
    }

    @Override
    public InsertTownVisit setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (InsertTownVisit) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public InsertTownVisit setQuotaUser(java.lang.String quotaUser) {
      return (InsertTownVisit) super.setQuotaUser(quotaUser);
    }

    @Override
    public InsertTownVisit setUserIp(java.lang.String userIp) {
      return (InsertTownVisit) super.setUserIp(userIp);
    }

    @Override
    public InsertTownVisit set(String parameterName, Object value) {
      return (InsertTownVisit) super.set(parameterName, value);
    }
  }
  ...
  /**
   * Create a request for the method "updateTownVisit".
   *
   * This request holds the parameters needed by the townvisitendpoint server.  After setting any
   * optional parameters, call the {@link UpdateTownVisit#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit}
   * @return the request
   */
  public UpdateTownVisit updateTownVisit(com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit content) throws java.io.IOException {
    UpdateTownVisit result = new UpdateTownVisit(content);
    initialize(result);
    return result;
  }

  public class UpdateTownVisit extends TownvisitendpointRequest<com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit> {
     ...
     *
     * This request holds the parameters needed by the the townvisitendpoint server.  After setting
     * any optional parameters, call the {@link UpdateTownVisit#execute()} method to invoke the remote
     * operation. <p> {@link UpdateTownVisit#initialize(com.google.api.client.googleapis.services.Abst
     * ractGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @param content the {@link com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit}
     * @since 1.13
     */
    protected UpdateTownVisit(com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit content) {
      super(Townvisitendpoint.this, "PUT", REST_PATH, content, com.inzynierkanew.entities.map.townvisitendpoint.model.TownVisit.class);
    }

    @Override
    public UpdateTownVisit setAlt(java.lang.String alt) {
      return (UpdateTownVisit) super.setAlt(alt);
    }

    @Override
    public UpdateTownVisit setFields(java.lang.String fields) {
      return (UpdateTownVisit) super.setFields(fields);
    }

    @Override
    public UpdateTownVisit setKey(java.lang.String key) {
      return (UpdateTownVisit) super.setKey(key);
    }

    @Override
    public UpdateTownVisit setOauthToken(java.lang.String oauthToken) {
      return (UpdateTownVisit) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateTownVisit setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateTownVisit) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateTownVisit setQuotaUser(java.lang.String quotaUser) {
      return (UpdateTownVisit) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateTownVisit setUserIp(java.lang.String userIp) {
      return (UpdateTownVisit) super.setUserIp(userIp);
    }

    @Override
    public UpdateTownVisit set(String parameterName, Object value) {
      return (UpdateTownVisit) super.set(parameterName, value);
    }
  }
