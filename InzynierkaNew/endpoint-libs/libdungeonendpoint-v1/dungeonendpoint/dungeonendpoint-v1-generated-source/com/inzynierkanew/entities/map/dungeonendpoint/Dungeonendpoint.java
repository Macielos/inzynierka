...
public class Dungeonendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "insertDungeon".
   *
   * This request holds the parameters needed by the dungeonendpoint server.  After setting any
  ...
  /**
   * Create a request for the method "updateDungeon".
   *
   * This request holds the parameters needed by the dungeonendpoint server.  After setting any
   * optional parameters, call the {@link UpdateDungeon#execute()} method to invoke the remote
   * operation.
   *
   * @param content the {@link com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon}
   * @return the request
   */
  public UpdateDungeon updateDungeon(com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon content) throws java.io.IOException {
    UpdateDungeon result = new UpdateDungeon(content);
    initialize(result);
    return result;
  }

  public class UpdateDungeon extends DungeonendpointRequest<com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon> {
     ...
     * This request holds the parameters needed by the the dungeonendpoint server.  After setting any
     * optional parameters, call the {@link UpdateDungeon#execute()} method to invoke the remote
     * operation. <p> {@link UpdateDungeon#initialize(com.google.api.client.googleapis.services.Abstra
     * ctGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @param content the {@link com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon}
     * @since 1.13
     */
    protected UpdateDungeon(com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon content) {
      super(Dungeonendpoint.this, "PUT", REST_PATH, content, com.inzynierkanew.entities.map.dungeonendpoint.model.Dungeon.class);
    }

    @Override
    public UpdateDungeon setAlt(java.lang.String alt) {
      return (UpdateDungeon) super.setAlt(alt);
    }

    @Override
    public UpdateDungeon setFields(java.lang.String fields) {
      return (UpdateDungeon) super.setFields(fields);
    }

    @Override
    public UpdateDungeon setKey(java.lang.String key) {
      return (UpdateDungeon) super.setKey(key);
    }

    @Override
    public UpdateDungeon setOauthToken(java.lang.String oauthToken) {
      return (UpdateDungeon) super.setOauthToken(oauthToken);
    }

    @Override
    public UpdateDungeon setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (UpdateDungeon) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public UpdateDungeon setQuotaUser(java.lang.String quotaUser) {
      return (UpdateDungeon) super.setQuotaUser(quotaUser);
    }

    @Override
    public UpdateDungeon setUserIp(java.lang.String userIp) {
      return (UpdateDungeon) super.setUserIp(userIp);
    }

    @Override
    public UpdateDungeon set(String parameterName, Object value) {
      return (UpdateDungeon) super.set(parameterName, value);
    }
  }
