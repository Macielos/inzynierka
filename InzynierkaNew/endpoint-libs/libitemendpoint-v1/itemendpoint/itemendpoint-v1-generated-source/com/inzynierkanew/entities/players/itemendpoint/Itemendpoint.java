 ...
 * on 2015-11-29 at 18:04:28 UTC 
 * Modify at your own risk.
 */

package com.inzynierkanew.entities.players.itemendpoint;
...
public class Itemendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetItem extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.Item> {
    ...
    protected GetItem(java.lang.Long id) {
      super(Itemendpoint.this, "GET", REST_PATH, null, com.inzynierkanew.entities.players.itemendpoint.model.Item.class);
  ...
  /**
   * Create a request for the method "getItemsByType".
   *
   * This request holds the parameters needed by the itemendpoint server.  After setting any optional
   * parameters, call the {@link GetItemsByType#execute()} method to invoke the remote operation.
   *
   * @param itemLevel
   * @param itemClass
   * @return the request
   */
  public GetItemsByType getItemsByType(java.lang.Integer itemLevel, java.lang.String itemClass) throws java.io.IOException {
    GetItemsByType result = new GetItemsByType(itemLevel, itemClass);
    initialize(result);
    return result;
  }

  public class GetItemsByType extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem> {

    private static final String REST_PATH = "collectionresponse_item/{itemLevel}/{itemClass}";

    /**
     * Create a request for the method "getItemsByType".
     *
     * This request holds the parameters needed by the the itemendpoint server.  After setting any
     * optional parameters, call the {@link GetItemsByType#execute()} method to invoke the remote
     * operation. <p> {@link GetItemsByType#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected GetItemsByType(java.lang.Integer itemLevel, java.lang.String itemClass) {
      super(Itemendpoint.this, "GET", REST_PATH, null, com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem.class);
      this.itemLevel = com.google.api.client.util.Preconditions.checkNotNull(itemLevel, "Required parameter itemLevel must be specified.");
    ...
    @Override
    public GetItemsByType setAlt(java.lang.String alt) {
      return (GetItemsByType) super.setAlt(alt);
    }

    @Override
    public GetItemsByType setFields(java.lang.String fields) {
      return (GetItemsByType) super.setFields(fields);
    }

    @Override
    public GetItemsByType setKey(java.lang.String key) {
      return (GetItemsByType) super.setKey(key);
    }

    @Override
    public GetItemsByType setOauthToken(java.lang.String oauthToken) {
      return (GetItemsByType) super.setOauthToken(oauthToken);
    }

    @Override
    public GetItemsByType setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetItemsByType) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetItemsByType setQuotaUser(java.lang.String quotaUser) {
      return (GetItemsByType) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetItemsByType setUserIp(java.lang.String userIp) {
      return (GetItemsByType) super.setUserIp(userIp);
    }
    ...
    public GetItemsByType setItemLevel(java.lang.Integer itemLevel) {
    ...
    public GetItemsByType setItemClass(java.lang.String itemClass) {
    ...
    public GetItemsByType setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public GetItemsByType set(String parameterName, Object value) {
      return (GetItemsByType) super.set(parameterName, value);
    }
  }
   ...
   *
   * @param content the {@link com.inzynierkanew.entities.players.itemendpoint.model.Item}
   * @return the request
   */
  public InsertItem insertItem(com.inzynierkanew.entities.players.itemendpoint.model.Item content) throws java.io.IOException {
    InsertItem result = new InsertItem(content);
    initialize(result);
    return result;
  }

  public class InsertItem extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.Item> {
     ...
     * @since 1.13
     */
    protected InsertItem(com.inzynierkanew.entities.players.itemendpoint.model.Item content) {
      super(Itemendpoint.this, "POST", REST_PATH, content, com.inzynierkanew.entities.players.itemendpoint.model.Item.class);
    }
  ...
  public class ListItem extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem> {
   ...
   * @return the request
   */
  public UpdateItem updateItem(com.inzynierkanew.entities.players.itemendpoint.model.Item content) throws java.io.IOException {
    UpdateItem result = new UpdateItem(content);
    initialize(result);
    return result;
  }

  public class UpdateItem extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.Item> {
     ...
     * @since 1.13
     */
    protected UpdateItem(com.inzynierkanew.entities.players.itemendpoint.model.Item content) {
      super(Itemendpoint.this, "PUT", REST_PATH, content, com.inzynierkanew.entities.players.itemendpoint.model.Item.class);
    }
