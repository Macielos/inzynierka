...
public class Itemendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * This request holds the parameters needed by the itemendpoint server.  After setting any optional
   * parameters, call the {@link GetItems#execute()} method to invoke the remote operation.
   *
   * @param ids
   * @return the request
   */
  public GetItems getItems(java.lang.String ids) throws java.io.IOException {
    GetItems result = new GetItems(ids);
    initialize(result);
    return result;
  }

  public class GetItems extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem> {

    private static final String REST_PATH = "collectionresponse_item/{ids}";
     ...
     * @since 1.13
     */
    protected GetItems(java.lang.String ids) {
    ...
    public GetItems setIds(java.lang.String ids) {
      this.ids = ids;
      return this;
    }
   ...
   *
   * This request holds the parameters needed by the itemendpoint server.  After setting any optional
   * parameters, call the {@link GetRandomItemsByType#execute()} method to invoke the remote
   * operation.
   *
   * @param limit
   * @param heroLevel
   ...
   * @return the request
   */
  public GetRandomItemsByType getRandomItemsByType(java.lang.Integer limit, java.lang.Integer heroLevel, java.lang.String itemClass) throws java.io.IOException {
    GetRandomItemsByType result = new GetRandomItemsByType(limit, heroLevel, itemClass);
    initialize(result);
    return result;
  }

  public class GetRandomItemsByType extends ItemendpointRequest<com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem> {

    private static final String REST_PATH = "collectionresponse_item/{limit}/{heroLevel}/{itemClass}";
     ...
     * @since 1.13
     */
    protected GetRandomItemsByType(java.lang.Integer limit, java.lang.Integer heroLevel, java.lang.String itemClass) {
      super(Itemendpoint.this, "GET", REST_PATH, null, com.inzynierkanew.entities.players.itemendpoint.model.CollectionResponseItem.class);
      this.limit = com.google.api.client.util.Preconditions.checkNotNull(limit, "Required parameter limit must be specified.");
      this.heroLevel = com.google.api.client.util.Preconditions.checkNotNull(heroLevel, "Required parameter heroLevel must be specified.");
    ...
    @com.google.api.client.util.Key
    private java.lang.Integer heroLevel;

    /**

     */
    public java.lang.Integer getHeroLevel() {
      return heroLevel;
    }

    public GetRandomItemsByType setHeroLevel(java.lang.Integer heroLevel) {
