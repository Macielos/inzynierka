...
public class Heroendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetActiveHeroesInLand extends HeroendpointRequest<com.inzynierkanew.entities.players.heroendpoint.model.CollectionResponseHero> {
   ...
   *
   * @param sendWorldUpdate
   * @param content the {@link com.inzynierkanew.entities.players.heroendpoint.model.Hero}
   * @return the request
   */
  public UpdateHero updateHero(java.lang.Boolean sendWorldUpdate, com.inzynierkanew.entities.players.heroendpoint.model.Hero content) throws java.io.IOException {
    UpdateHero result = new UpdateHero(sendWorldUpdate, content);
    initialize(result);
    return result;
  }
  ...
  public class UpdateHero extends HeroendpointRequest<com.inzynierkanew.entities.players.heroendpoint.model.Hero> {
    ...
    private static final String REST_PATH = "hero/{sendWorldUpdate}";
     ...
     * @since 1.13
     */
    protected UpdateHero(java.lang.Boolean sendWorldUpdate, com.inzynierkanew.entities.players.heroendpoint.model.Hero content) {
      super(Heroendpoint.this, "PUT", REST_PATH, content, com.inzynierkanew.entities.players.heroendpoint.model.Hero.class);
      this.sendWorldUpdate = com.google.api.client.util.Preconditions.checkNotNull(sendWorldUpdate, "Required parameter sendWorldUpdate must be specified.");
    }
    ...
    @com.google.api.client.util.Key
    private java.lang.Boolean sendWorldUpdate;

    /**

     */
    public java.lang.Boolean getSendWorldUpdate() {
      return sendWorldUpdate;
    }

    public UpdateHero setSendWorldUpdate(java.lang.Boolean sendWorldUpdate) {
      this.sendWorldUpdate = sendWorldUpdate;
      return this;
    }
