...
public class Landendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetTown getTown(java.lang.Long landId) throws java.io.IOException {
    GetTown result = new GetTown(landId);
    initialize(result);
    return result;
  }

  public class GetTown extends LandendpointRequest<com.inzynierkanew.entities.map.landendpoint.model.Town> {

    private static final String REST_PATH = "town/{landId}";
     ...
     * @since 1.13
     */
    protected GetTown(java.lang.Long landId) {
      super(Landendpoint.this, "GET", REST_PATH, null, com.inzynierkanew.entities.map.landendpoint.model.Town.class);
    ...
    public GetTown setLandId(java.lang.Long landId) {
      this.landId = landId;
      return this;
    }
   ...
   *
   * @param content the {@link com.inzynierkanew.entities.map.landendpoint.model.Town}
   * @return the request
   */
  public UpdateTown updateTown(com.inzynierkanew.entities.map.landendpoint.model.Town content) throws java.io.IOException {
    UpdateTown result = new UpdateTown(content);
    initialize(result);
    return result;
  }

  public class UpdateTown extends LandendpointRequest<com.inzynierkanew.entities.map.landendpoint.model.Town> {
     ...
     * @since 1.13
     */
    protected UpdateTown(com.inzynierkanew.entities.map.landendpoint.model.Town content) {
      super(Landendpoint.this, "PUT", REST_PATH, content, com.inzynierkanew.entities.map.landendpoint.model.Town.class);
    }
