...
public class Unittypeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUnitType extends UnittypeendpointRequest<com.explorersguild.entities.players.unittypeendpoint.model.UnitType> {
    ...
    protected GetUnitType(java.lang.Long id) {
      super(Unittypeendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.players.unittypeendpoint.model.UnitType.class);
   ...
   * operation.
   *
   * @param content the {@link com.explorersguild.entities.players.unittypeendpoint.model.UnitType}
   * @return the request
   */
  public InsertUnitType insertUnitType(com.explorersguild.entities.players.unittypeendpoint.model.UnitType content) throws java.io.IOException {
    InsertUnitType result = new InsertUnitType(content);
    initialize(result);
    return result;
  }

  public class InsertUnitType extends UnittypeendpointRequest<com.explorersguild.entities.players.unittypeendpoint.model.UnitType> {
     ...
     * @since 1.13
     */
    protected InsertUnitType(com.explorersguild.entities.players.unittypeendpoint.model.UnitType content) {
      super(Unittypeendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.players.unittypeendpoint.model.UnitType.class);
    }
  ...
  public class ListUnitType extends UnittypeendpointRequest<com.explorersguild.entities.players.unittypeendpoint.model.CollectionResponseUnitType> {
    ...
    protected ListUnitType() {
      super(Unittypeendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.players.unittypeendpoint.model.CollectionResponseUnitType.class);
    }
