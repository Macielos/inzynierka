 ...
 * on 2016-02-01 at 02:49:23 UTC 
 * Modify at your own risk.
 */

package com.explorersguild.entities.map.landendpoint;
...
public class Landendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class LandEndpoint {
    ...
    public class FindLandForNewPlayer extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.Land> {
      ...
      protected FindLandForNewPlayer() {
        super(Landendpoint.this, "POST", REST_PATH, null, com.explorersguild.entities.map.landendpoint.model.Land.class);
      }
    ...
    /**
     * Create a request for the method "landEndpoint.findLandsInNeighbourhood".
     *
     * This request holds the parameters needed by the landendpoint server.  After setting any optional
    ...
    public class FindLandsInNeighbourhood extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.CollectionResponseLand> {
      ...
      protected FindLandsInNeighbourhood(java.lang.Long mapSegment) {
        super(Landendpoint.this, "POST", REST_PATH, null, com.explorersguild.entities.map.landendpoint.model.CollectionResponseLand.class);
    ...
    /**
     * Create a request for the method "landEndpoint.findLandsWithFreePassages".
     *
     * This request holds the parameters needed by the landendpoint server.  After setting any optional
    ...
    public class FindLandsWithFreePassages extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.CollectionResponseLand> {
  ...
  public class GetLand extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.Land> {
    ...
    protected GetLand(java.lang.Long id) {
      super(Landendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.landendpoint.model.Land.class);
   ...
   *
   * @param content the {@link com.explorersguild.entities.map.landendpoint.model.Land}
   * @return the request
   */
  public InsertLand insertLand(com.explorersguild.entities.map.landendpoint.model.Land content) throws java.io.IOException {
    InsertLand result = new InsertLand(content);
    initialize(result);
    return result;
  }

  public class InsertLand extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.Land> {
     ...
     * @since 1.13
     */
    protected InsertLand(com.explorersguild.entities.map.landendpoint.model.Land content) {
      super(Landendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.map.landendpoint.model.Land.class);
    }
  ...
  public class ListLand extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.CollectionResponseLand> {
     ...
     */
    protected ListLand() {
      super(Landendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.landendpoint.model.CollectionResponseLand.class);
    }
   ...
   * @return the request
   */
  public UpdateLand updateLand(com.explorersguild.entities.map.landendpoint.model.Land content) throws java.io.IOException {
    UpdateLand result = new UpdateLand(content);
    initialize(result);
    return result;
  }

  public class UpdateLand extends LandendpointRequest<com.explorersguild.entities.map.landendpoint.model.Land> {
     ...
     * @since 1.13
     */
    protected UpdateLand(com.explorersguild.entities.map.landendpoint.model.Land content) {
      super(Landendpoint.this, "PUT", REST_PATH, content, com.explorersguild.entities.map.landendpoint.model.Land.class);
    }
