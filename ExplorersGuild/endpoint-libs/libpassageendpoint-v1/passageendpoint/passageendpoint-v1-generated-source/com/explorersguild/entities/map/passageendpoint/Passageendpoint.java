 ...
 * on 2016-02-01 at 02:49:15 UTC 
 * Modify at your own risk.
 */

package com.explorersguild.entities.map.passageendpoint;
...
public class Passageendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "findInactivePortal".
   *
   * This request holds the parameters needed by the passageendpoint server.  After setting any
   * optional parameters, call the {@link FindInactivePortal#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public FindInactivePortal findInactivePortal() throws java.io.IOException {
    FindInactivePortal result = new FindInactivePortal();
    initialize(result);
    return result;
  }

  public class FindInactivePortal extends PassageendpointRequest<com.explorersguild.entities.map.passageendpoint.model.Passage> {

    private static final String REST_PATH = "findInactivePortal";
     ...
     * optional parameters, call the {@link FindInactivePortal#execute()} method to invoke the remote
     * operation. <p> {@link FindInactivePortal#initialize(com.google.api.client.googleapis.services.A
     * bstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected FindInactivePortal() {
      super(Passageendpoint.this, "POST", REST_PATH, null, com.explorersguild.entities.map.passageendpoint.model.Passage.class);
    }

    @Override
    public FindInactivePortal setAlt(java.lang.String alt) {
      return (FindInactivePortal) super.setAlt(alt);
    }

    @Override
    public FindInactivePortal setFields(java.lang.String fields) {
      return (FindInactivePortal) super.setFields(fields);
    }

    @Override
    public FindInactivePortal setKey(java.lang.String key) {
      return (FindInactivePortal) super.setKey(key);
    }

    @Override
    public FindInactivePortal setOauthToken(java.lang.String oauthToken) {
      return (FindInactivePortal) super.setOauthToken(oauthToken);
    }

    @Override
    public FindInactivePortal setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (FindInactivePortal) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public FindInactivePortal setQuotaUser(java.lang.String quotaUser) {
      return (FindInactivePortal) super.setQuotaUser(quotaUser);
    }

    @Override
    public FindInactivePortal setUserIp(java.lang.String userIp) {
      return (FindInactivePortal) super.setUserIp(userIp);
    }

    @Override
    public FindInactivePortal set(String parameterName, Object value) {
      return (FindInactivePortal) super.set(parameterName, value);
    }
  }
  ...
  public class GetPassage extends PassageendpointRequest<com.explorersguild.entities.map.passageendpoint.model.Passage> {
    ...
    protected GetPassage(java.lang.Long id) {
      super(Passageendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.passageendpoint.model.Passage.class);
   ...
   * operation.
   *
   * @param content the {@link com.explorersguild.entities.map.passageendpoint.model.Passage}
   * @return the request
   */
  public InsertPassage insertPassage(com.explorersguild.entities.map.passageendpoint.model.Passage content) throws java.io.IOException {
    InsertPassage result = new InsertPassage(content);
    initialize(result);
    return result;
  }

  public class InsertPassage extends PassageendpointRequest<com.explorersguild.entities.map.passageendpoint.model.Passage> {
     ...
     * @since 1.13
     */
    protected InsertPassage(com.explorersguild.entities.map.passageendpoint.model.Passage content) {
      super(Passageendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.map.passageendpoint.model.Passage.class);
    }
   ...
   * @return the request
   */
  public ListPassage listPassage(java.lang.Long landId) throws java.io.IOException {
    ListPassage result = new ListPassage(landId);
    initialize(result);
    return result;
  }

  public class ListPassage extends PassageendpointRequest<com.explorersguild.entities.map.passageendpoint.model.CollectionResponsePassage> {

    private static final String REST_PATH = "listPassage/{landId}";
     ...
     * @since 1.13
     */
    protected ListPassage(java.lang.Long landId) {
      super(Passageendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.passageendpoint.model.CollectionResponsePassage.class);
    ...
    public ListPassage setLandId(java.lang.Long landId) {
      this.landId = landId;
      return this;
    }
   ...
   * @return the request
   */
  public UpdatePassage updatePassage(com.explorersguild.entities.map.passageendpoint.model.Passage content) throws java.io.IOException {
    UpdatePassage result = new UpdatePassage(content);
    initialize(result);
    return result;
  }

  public class UpdatePassage extends PassageendpointRequest<com.explorersguild.entities.map.passageendpoint.model.Passage> {
     ...
     * @since 1.13
     */
    protected UpdatePassage(com.explorersguild.entities.map.passageendpoint.model.Passage content) {
      super(Passageendpoint.this, "PUT", REST_PATH, content, com.explorersguild.entities.map.passageendpoint.model.Passage.class);
    }
