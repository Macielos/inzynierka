 ...
 * on 2016-02-01 at 02:49:34 UTC 
 * Modify at your own risk.
 */

package com.explorersguild.entities.players.heroendpoint;
...
public class Heroendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getActiveHeroesInLand".
   *
   * This request holds the parameters needed by the heroendpoint server.  After setting any optional
   * parameters, call the {@link GetActiveHeroesInLand#execute()} method to invoke the remote
   * operation.
   *
   * @param landId
   * @return the request
   */
  public GetActiveHeroesInLand getActiveHeroesInLand(java.lang.Long landId) throws java.io.IOException {
    GetActiveHeroesInLand result = new GetActiveHeroesInLand(landId);
    initialize(result);
    return result;
  }

  public class GetActiveHeroesInLand extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.CollectionResponseHero> {

    private static final String REST_PATH = "collectionresponse_hero/{landId}";

    /**
     * Create a request for the method "getActiveHeroesInLand".
     *
     * This request holds the parameters needed by the the heroendpoint server.  After setting any
     * optional parameters, call the {@link GetActiveHeroesInLand#execute()} method to invoke the
     * remote operation. <p> {@link GetActiveHeroesInLand#initialize(com.google.api.client.googleapis.
     ...
     * @since 1.13
     */
    protected GetActiveHeroesInLand(java.lang.Long landId) {
      super(Heroendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.players.heroendpoint.model.CollectionResponseHero.class);
    ...
    @Override
    public GetActiveHeroesInLand setAlt(java.lang.String alt) {
      return (GetActiveHeroesInLand) super.setAlt(alt);
    }

    @Override
    public GetActiveHeroesInLand setFields(java.lang.String fields) {
      return (GetActiveHeroesInLand) super.setFields(fields);
    }

    @Override
    public GetActiveHeroesInLand setKey(java.lang.String key) {
      return (GetActiveHeroesInLand) super.setKey(key);
    }

    @Override
    public GetActiveHeroesInLand setOauthToken(java.lang.String oauthToken) {
      return (GetActiveHeroesInLand) super.setOauthToken(oauthToken);
    }

    @Override
    public GetActiveHeroesInLand setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetActiveHeroesInLand) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetActiveHeroesInLand setQuotaUser(java.lang.String quotaUser) {
      return (GetActiveHeroesInLand) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetActiveHeroesInLand setUserIp(java.lang.String userIp) {
      return (GetActiveHeroesInLand) super.setUserIp(userIp);
    }
    ...
    public GetActiveHeroesInLand setLandId(java.lang.Long landId) {
      this.landId = landId;
      return this;
    }

    @Override
    public GetActiveHeroesInLand set(String parameterName, Object value) {
      return (GetActiveHeroesInLand) super.set(parameterName, value);
    }
  }
  ...
  public class GetHero extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.Hero> {
    ...
    protected GetHero(java.lang.Long id) {
      super(Heroendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.players.heroendpoint.model.Hero.class);
  ...
  /**
   * Create a request for the method "getHighestLevelHero".
   *
   * This request holds the parameters needed by the heroendpoint server.  After setting any optional
   * parameters, call the {@link GetHighestLevelHero#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetHighestLevelHero getHighestLevelHero() throws java.io.IOException {
    GetHighestLevelHero result = new GetHighestLevelHero();
    initialize(result);
    return result;
  }

  public class GetHighestLevelHero extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.Hero> {

    private static final String REST_PATH = "getHighestLevelHero";

    /**
     * Create a request for the method "getHighestLevelHero".
     *
     * This request holds the parameters needed by the the heroendpoint server.  After setting any
     * optional parameters, call the {@link GetHighestLevelHero#execute()} method to invoke the remote
     * operation. <p> {@link GetHighestLevelHero#initialize(com.google.api.client.googleapis.services.
     * AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected GetHighestLevelHero() {
      super(Heroendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.players.heroendpoint.model.Hero.class);
    }
    ...
    @Override
    public GetHighestLevelHero setAlt(java.lang.String alt) {
      return (GetHighestLevelHero) super.setAlt(alt);
    }

    @Override
    public GetHighestLevelHero setFields(java.lang.String fields) {
      return (GetHighestLevelHero) super.setFields(fields);
    }

    @Override
    public GetHighestLevelHero setKey(java.lang.String key) {
      return (GetHighestLevelHero) super.setKey(key);
    }

    @Override
    public GetHighestLevelHero setOauthToken(java.lang.String oauthToken) {
      return (GetHighestLevelHero) super.setOauthToken(oauthToken);
    }

    @Override
    public GetHighestLevelHero setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetHighestLevelHero) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetHighestLevelHero setQuotaUser(java.lang.String quotaUser) {
      return (GetHighestLevelHero) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetHighestLevelHero setUserIp(java.lang.String userIp) {
      return (GetHighestLevelHero) super.setUserIp(userIp);
    }

    @Override
    public GetHighestLevelHero set(String parameterName, Object value) {
      return (GetHighestLevelHero) super.set(parameterName, value);
    }
  }
   ...
   *
   * @param content the {@link com.explorersguild.entities.players.heroendpoint.model.Hero}
   * @return the request
   */
  public InsertHero insertHero(com.explorersguild.entities.players.heroendpoint.model.Hero content) throws java.io.IOException {
    InsertHero result = new InsertHero(content);
    initialize(result);
    return result;
  }

  public class InsertHero extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.Hero> {
     ...
     * @since 1.13
     */
    protected InsertHero(com.explorersguild.entities.players.heroendpoint.model.Hero content) {
      super(Heroendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.players.heroendpoint.model.Hero.class);
    }
  ...
  public class ListHero extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.CollectionResponseHero> {
   ...
   *
   * This request holds the parameters needed by the heroendpoint server.  After setting any optional
   * parameters, call the {@link MoveHeroToDifferentLand#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @param nextLandId
  ...
  public class MoveHeroToDifferentLand extends HeroendpointRequest<Void> {
    ...
    protected MoveHeroToDifferentLand(java.lang.Long id, java.lang.Long nextLandId, java.lang.Integer x, java.lang.Integer y) {
      super(Heroendpoint.this, "POST", REST_PATH, null, Void.class);
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
   ...
   * @return the request
   */
  public UpdateHero updateHero(java.lang.Integer action, com.explorersguild.entities.players.heroendpoint.model.Hero content) throws java.io.IOException {
    UpdateHero result = new UpdateHero(action, content);
    initialize(result);
    return result;
  }

  public class UpdateHero extends HeroendpointRequest<com.explorersguild.entities.players.heroendpoint.model.Hero> {

    private static final String REST_PATH = "hero/{action}";
     ...
     * @since 1.13
     */
    protected UpdateHero(java.lang.Integer action, com.explorersguild.entities.players.heroendpoint.model.Hero content) {
      super(Heroendpoint.this, "PUT", REST_PATH, content, com.explorersguild.entities.players.heroendpoint.model.Hero.class);
    ...
    public UpdateHero setAction(java.lang.Integer action) {
      this.action = action;
      return this;
    }
