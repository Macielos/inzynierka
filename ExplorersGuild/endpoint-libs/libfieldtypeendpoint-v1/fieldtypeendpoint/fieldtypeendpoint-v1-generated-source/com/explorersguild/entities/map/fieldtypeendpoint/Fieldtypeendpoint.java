...
public class Fieldtypeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * <pre>
   *   {@code Fieldtypeendpoint fieldtypeendpoint = new Fieldtypeendpoint(...);}
   *   {@code Fieldtypeendpoint.FieldTypeEndpoint.List request = fieldtypeendpoint.fieldTypeEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  public class FieldTypeEndpoint {
    ...
    /**
     * Create a request for the method "fieldTypeEndpoint.insertFieldType".
     *
     ...
     * operation.
     *
     * @param content the {@link com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType}
     * @return the request
     */
    public InsertFieldType insertFieldType(com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType content) throws java.io.IOException {
      InsertFieldType result = new InsertFieldType(content);
      initialize(result);
      return result;
    }

    public class InsertFieldType extends FieldtypeendpointRequest<com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType> {
       ...
       * @since 1.13
       */
      protected InsertFieldType(com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType content) {
        super(Fieldtypeendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType.class);
      }
  ...
  public class GetFieldType extends FieldtypeendpointRequest<com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType> {
    ...
    protected GetFieldType(java.lang.Long id) {
      super(Fieldtypeendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.fieldtypeendpoint.model.FieldType.class);
  ...
  public class ListFieldType extends FieldtypeendpointRequest<com.explorersguild.entities.map.fieldtypeendpoint.model.CollectionResponseFieldType> {
    ...
    protected ListFieldType() {
      super(Fieldtypeendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.fieldtypeendpoint.model.CollectionResponseFieldType.class);
    }
