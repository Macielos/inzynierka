...
public class Dungeonvisitendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDungeonVisitsByIds extends DungeonvisitendpointRequest<com.explorersguild.entities.map.dungeonvisitendpoint.model.CollectionResponseDungeonVisit> {
    ...
    protected ListDungeonVisitsByIds(java.lang.Long heroId, java.lang.Long relatedEntityId, java.lang.Boolean byLand) {
      super(Dungeonvisitendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.dungeonvisitendpoint.model.CollectionResponseDungeonVisit.class);
   ...
   * operation.
   *
   * @param content the {@link com.explorersguild.entities.map.dungeonvisitendpoint.model.DungeonVisit}
   * @return the request
   */
  public SaveDungeonVisit saveDungeonVisit(com.explorersguild.entities.map.dungeonvisitendpoint.model.DungeonVisit content) throws java.io.IOException {
    SaveDungeonVisit result = new SaveDungeonVisit(content);
    initialize(result);
    return result;
  }

  public class SaveDungeonVisit extends DungeonvisitendpointRequest<com.explorersguild.entities.map.dungeonvisitendpoint.model.DungeonVisit> {
     ...
     * @since 1.13
     */
    protected SaveDungeonVisit(com.explorersguild.entities.map.dungeonvisitendpoint.model.DungeonVisit content) {
      super(Dungeonvisitendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.map.dungeonvisitendpoint.model.DungeonVisit.class);
    }
