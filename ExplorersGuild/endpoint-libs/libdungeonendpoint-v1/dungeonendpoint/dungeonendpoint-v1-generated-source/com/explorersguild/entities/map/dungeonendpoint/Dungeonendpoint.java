...
public class Dungeonendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class DungeonEndpoint {
     ...
     * operation.
     *
     * @param content the {@link com.explorersguild.entities.map.dungeonendpoint.model.Dungeon}
     * @return the request
     */
    public InsertDungeon insertDungeon(com.explorersguild.entities.map.dungeonendpoint.model.Dungeon content) throws java.io.IOException {
      InsertDungeon result = new InsertDungeon(content);
      initialize(result);
      return result;
    }

    public class InsertDungeon extends DungeonendpointRequest<com.explorersguild.entities.map.dungeonendpoint.model.Dungeon> {
       ...
       * @since 1.13
       */
      protected InsertDungeon(com.explorersguild.entities.map.dungeonendpoint.model.Dungeon content) {
        super(Dungeonendpoint.this, "POST", REST_PATH, content, com.explorersguild.entities.map.dungeonendpoint.model.Dungeon.class);
      }
  ...
  public class GetDungeon extends DungeonendpointRequest<com.explorersguild.entities.map.dungeonendpoint.model.Dungeon> {
    ...
    protected GetDungeon(java.lang.Long id) {
      super(Dungeonendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.dungeonendpoint.model.Dungeon.class);
  ...
  public class ListDungeon extends DungeonendpointRequest<com.explorersguild.entities.map.dungeonendpoint.model.CollectionResponseDungeon> {
    ...
    protected ListDungeon(java.lang.Long landId) {
      super(Dungeonendpoint.this, "GET", REST_PATH, null, com.explorersguild.entities.map.dungeonendpoint.model.CollectionResponseDungeon.class);
