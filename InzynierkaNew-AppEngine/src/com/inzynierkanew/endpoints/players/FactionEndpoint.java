...
@Api(name = "factionendpoint", namespace = @ApiNamespace(ownerDomain = "inzynierkanew.com", ownerName = "inzynierkanew.com", packagePath = "entities.players"))
public class FactionEndpoint {
	 ...
	 *
	 * @param faction the entity to be updated.
	 * @return The updated entity.
	 */
	@ApiMethod(name = "updateFaction")
	 ...
	 */
	@ApiMethod(name = "removeFaction")
	public void removeFaction(@Named("id") Long id) {
		EntityManager mgr = getEntityManager();
		try {
			Faction faction = mgr.find(Faction.class, id);
			mgr.remove(faction);
		} finally {
			mgr.close();
		}
