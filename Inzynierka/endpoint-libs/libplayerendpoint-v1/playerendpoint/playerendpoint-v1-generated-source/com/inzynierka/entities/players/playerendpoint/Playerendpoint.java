...
public class Playerendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * operation.
   *
   * @param content the {@link com.inzynierka.entities.players.playerendpoint.model.Player}
   * @return the request
   */
  public InsertPlayer insertPlayer(com.inzynierka.entities.players.playerendpoint.model.Player content) throws java.io.IOException {
    InsertPlayer result = new InsertPlayer(content);
    initialize(result);
    return result;
  }

  public class InsertPlayer extends PlayerendpointRequest<com.inzynierka.entities.players.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected InsertPlayer(com.inzynierka.entities.players.playerendpoint.model.Player content) {
      super(Playerendpoint.this, "POST", REST_PATH, content, com.inzynierka.entities.players.playerendpoint.model.Player.class);
    }
   ...
   * @return the request
   */
  public UpdatePlayer updatePlayer(com.inzynierka.entities.players.playerendpoint.model.Player content) throws java.io.IOException {
    UpdatePlayer result = new UpdatePlayer(content);
    initialize(result);
    return result;
  }

  public class UpdatePlayer extends PlayerendpointRequest<com.inzynierka.entities.players.playerendpoint.model.Player> {
     ...
     * @since 1.13
     */
    protected UpdatePlayer(com.inzynierka.entities.players.playerendpoint.model.Player content) {
      super(Playerendpoint.this, "PUT", REST_PATH, content, com.inzynierka.entities.players.playerendpoint.model.Player.class);
    }
